...
ShConfig = { --- THIS IS A SHARED CONFIG -- Is what this means is you can call this config in any resource with Framework.Config then whatever option you are looking for 
    ...
    MenuResource = 'nh-context', -- qb-menu or nh-context ( make sure its the newest versions - Nirohiro made nh-context only download that one not all the other forks.)
    InventoryResource = Config.Inventory, --- CHange this above dont change it here. 
    InputResource = '710-input', -- qb-input or 710-input (710-input is just a fork of qb-input with no changes besides the name i just did that cause ESX people would get mad they needed a qb resource lol)
